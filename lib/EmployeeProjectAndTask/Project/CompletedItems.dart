...
class CompletedItems extends StatefulWidget {
  ...
  const CompletedItems({super.key, required this.title, required this.tileColor, required this.description, required this.descriptionColor});
  @override
              ...
              body: Column(
                children: [
                          ...
                          children: [
                            Padding(
                              ...
                              child: Align(
                                ...
                                child: Text(widget.title, style: Fonts.bodyFonts),
                              ),
                            ),
                          ],
                        ),
                  ...
                  Padding(
                    ...
                    child: Align(
                      alignment: Alignment.topLeft,
                      child: Text("Completed Date", style: Fonts.smallFonts,),
                    ),
                  ),
                  Row(
                    children: [
